...
.actu-nav .actu-nav-list .menu-item a {
  color: #e2e2e2;
  text-decoration: none;
}
.actu-nav .actu-nav-list .menu-item a:hover {
  color: #d3bea1;
}
