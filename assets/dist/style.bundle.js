...
.section_actu_2_cards .actu-card {
  max-height: 600px;
}
.section_actu_2_cards .actu-card .actu-card-img {
  position: relative;
  background-color: #e2e2e2;
  aspect-ratio: 4/3;
  overflow: hidden;
...
.section_actu_2_cards .actu-card .actu-card-img img {
  width: 100%;
  height: 100%;
  -o-object-fit: cover;
     object-fit: cover;
...
.section_actu_2_cards .actu-card .actu-card-plus {
  position: absolute;
  bottom: -1px;
  right: -1px;
  width: 80px;
...
.section_actu_2_cards .actu-card:hover .actu-card-img img {
  transform: scale(1.05);
  filter: brightness(0.6);
}
.section_actu_2_cards .actu-card:hover .actu-card-plus {
  background-color: #05233c;
  color: #fff;
}
...
.section-gallery-bl-gr .gallery-titre {
  color: #05233c;
  text-transform: uppercase;
  font-size: 3rem;
  margin: 50px 0;
...
.section-gallery-bl-gr .gallery-ssTitre {
  color: #05233c;
  font-size: 2.5rem;
  line-height: 1.2;
  width: 350px;
...
.section-gallery-bl-gr .gallery-paragraph {
  color: #05233c;
  width: 350px;
  padding-right: 80px;
  padding-bottom: 100px;
